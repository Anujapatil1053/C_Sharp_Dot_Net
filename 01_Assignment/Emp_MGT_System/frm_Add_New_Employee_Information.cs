...
{
    public partial class frm_Add_New_Employe : Form
    {
        public frm_Add_New_Employe()
        {
            InitializeComponent();
        }

        SqlConnection Con = new SqlConnection(@"Data Source=.\SQLEXPRESS;Initial Catalog=Emp_MGT_System;Integrated Security=True");
        void Con_Open()
        {
        ...
        private void frm_Add_New_Employe_Load(object sender, EventArgs e)
        {
            tb_Name.Focus();
        }
